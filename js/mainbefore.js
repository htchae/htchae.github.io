 ...
 * Optimized for GIFs instead of videos
 */
...
/**
 * Initialize navigation functionality with improved mobile experience
 */
...
<li>2의 제곱이 아닌 이미지는 일반적으로 기기 메모리에 4배 더 부담
 ...
 <div class="user-flow-section">
  ...
  //   // Use the appropriate language version of the description
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const imageQueue = Array.from(
    document.querySelectorAll('img:not(.lazy-gif)')
  );
...
/**
 * Add smooth touch scrolling behavior
//  */
